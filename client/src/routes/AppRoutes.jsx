...
const ProfileCustomOrderDetailsPage = lazy(() => import('../pages/ProfileCustomOrderDetailsPage.jsx'))
...
const AdminCancellationsPage = lazy(() => import('../pages/admin/AdminCancellationsPage.jsx'))
const AdminUsersPage = lazy(() => import('../pages/admin/AdminUsersPage.jsx'))
const AdminUserDeletionLogsPage = lazy(() => import('../pages/admin/AdminUserDeletionLogsPage.jsx'))
          ...
          <Route element={<ProtectedRoute />}>
            ...
            <Route element={<CustomerRoute />}>
              ...
              <Route path="profile" element={<ProfileLayout />}>
                ...
                <Route path="custom-orders/:id" element={<ProfileCustomOrderDetailsPage />} />
