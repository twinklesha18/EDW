...
export const recoveryRequestRateLimiter = limiter({ windowMs: 60 * 60 * 1000, limit: 6 })
export const otpVerificationRateLimiter = limiter({ windowMs: 15 * 60 * 1000, limit: 10 })
export const recoveryCompletionRateLimiter = limiter({ windowMs: 60 * 60 * 1000, limit: 6 })
